...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/waste-management-system-main/erification/index.html">
        ...
        <ul class="nav navbar-right top-nav">           
            <li>
                <a href="#" data-placement="bottom"  data-toggle="tooltip"> <h5><?php echo 'Admin: Chetan Wani' ;?></h5> 
            </li>
        </ul>
    ...
    if ($total != 0) {
        while ($result = mysqli_fetch_assoc($data)) {
            ...
            <tr class='panel panel'>
                ...
                <td>
                    <a href='" . $hostForImage . htmlspecialchars($result['file']) . "'>
                        <img src='" . $hostForImage . htmlspecialchars($result['file']) . "' height='200' width='200' />
                    </a>
                </td>
            ...
            <td> " . htmlspecialchars($result['wastetype']) . " </td>
            <td> " . htmlspecialchars($result['location']) . " </td>
            <td> " . htmlspecialchars($result['locationdescription']) . " </td>
            <td> " . htmlspecialchars($result['status']) . " </td>
            <td><a href='admindelete.php?i=" . urlencode($result['Id']) . "' class='btn btn-danger'>Delete</a></td>
            <td><a href='status.php?i=" . urlencode($result['Id']) . "&s=" . urlencode($result['status']) . "' class='btn btn-success'>Status</a></td>
        </tr>";
    }
}
...
//     window.location.replace("/waste-management-system-main/adminsignup/admindelete.php?i="+delId);
// }
</script>
</body>
</html>