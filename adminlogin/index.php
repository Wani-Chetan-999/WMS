...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/waste-management-system-main/index.html">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="#" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-search"></i><mark> Dashboard</mark> <i class="fa fa-fw fa-angle-down pull-right"></i></a>
...
function confirmDelete(){
    window.location.replace("/waste-management-system-main/adminlogin/admindelete.php?i="+delId);
}
</script>
</body>
</html>